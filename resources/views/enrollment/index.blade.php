                ...
                <table class="table">
                    ...
                    @foreach($enrollments as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ ('/enrollments/' . $item->id) }}" title="View Enrollment"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>View</button></a>
                                <a href="{{ ('/enrollments/' . $item->id . '/edit') }}" title="Edit Enrollment"><button class="btn btn-info btn-sm"><i class="fa fa-pencil-square-0" aria-hidden="true"></i>Edit</button></a>
