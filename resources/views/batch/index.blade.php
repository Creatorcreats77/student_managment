                ...
                <table class="table">
                    ...
                    @foreach($batches as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ ('/batches/' . $item->id) }}" title="View Batch"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>View</button></a>
                                <a href="{{ ('/batches/' . $item->id . '/edit') }}" title="Edit Batch"><button class="btn btn-info btn-sm"><i class="fa fa-pencil-square-0" aria-hidden="true"></i>Edit</button></a>
